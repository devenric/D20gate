...
<body>
    <div class="main-wrapper">
        <div class="edit-container">
            ...
            <?php if ($personaje): ?>
                <div class="character-preview">
                    <div class="preview-avatar">
                        <img src="https://api.dicebear.com/7.x/adventurer/svg?seed=<?= urlencode($personaje->getNombre()) ?>" alt="Avatar">
                    </div>
            ...
            <form method="POST" enctype="multipart/form-data" id="editForm" class="rpg-form">
                <div class="form-grid">
                    <div class="form-column">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="nivel" name="nivel" min="1" max="20" value="<?= htmlspecialchars($personaje->getNivel() ?? 1) ?>" required>
                        </div>
                    ...
                    <div class="form-column">
                        <div class="form-group spell-section">
                            ...
                            <button type="button" class="btn-magic" onclick="showSpellSelection()">CAMBIAR HECHIZO</button>
...
echo '<div class="photo-option" onclick="selectPreviousPhoto(event, \'' . htmlspecialchars($photo) . '\')">';                                echo '<img src="' . $uploadDir . $photo . '" alt="Anterior">';
                                echo '</div>';
                            }
                        }
                        ?>
                ...
                <div class="button-group">
                    ...
                    <button type="button" class="btn-submit" onclick="submitForm()">GUARDAR CAMBIOS</button>
                </div>
            </form>
        </div>
    </div>
